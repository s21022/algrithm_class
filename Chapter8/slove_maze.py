...
maze = [
    ...
    [99,  0, 99, 99,  0, 99, 99,  0, 99, 99,  0, 99, 99, 99, 99, 99, 99],
    [99, 99, 99,  0,  0,  0, 99,  0, 99, 99,  0, 99,  0,  0, 99,  0, 99],
    [99,  0,  0,  0, 99,  0,  0,  0, 99, 99,  0, 99,  0,  0, 99,  0, 99],
    [99,  0, 99,  0,  0,  0, 99,  0, 99, 99,  0,  0,  0,  0,  0,  0, 99],
    [99, 99, 99,  0,  0,  0, 99,  0, 99, 99,  0, 99,  0,  0, 99,  0, 99],
    [99,  0,  0,  0, 99,  0,  0,  0, 99, 99,  0, 99,  0,  0, 99,  0, 99],
    [99,  0, 99,  0,  0,  0, 99,  0, 99, 99,  0,  0,  0,  0,  0,  0, 99],
    [99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99],
...
root = tkinter.Tk()
root.title("迷路を解く")
cvs = tkinter.Canvas(width=1280, height=680)
cvs.pack()
